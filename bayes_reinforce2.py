...
from gym_idsgame.agents.training_agents.bayesian_methods.policy_gradient.reinforce.bayes_reinforce2 import BayesReinforceAgent
...
if __name__ == '__main__':
    random_seed = 1010000000000000000
    ...
    pg_agent_config = PolicyGradientAgentConfig(gamma=0.999, alpha_attacker=0.00001, epsilon=1, render=False,
                                                eval_sleep=0.9,
                                                min_epsilon=0.01, eval_episodes=100, train_log_frequency=5,
                                                ...
                                                eval_frequency=500, attacker=True, defender=False,
                                                video_frequency=101,
